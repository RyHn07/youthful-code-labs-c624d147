        ...
        {pillars.map((p, i) => (
          <ScrollReveal key={p.title} delay={i * 0.08}>
            <GlassCard className="group h-full transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_30px_60px_-30px_rgba(91,101,220,0.4)]">
              <div className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-[color:var(--brand-indigo)] to-[color:var(--brand-navy)] text-white shadow-[0_8px_24px_-8px_rgba(91,101,220,0.5)] transition-transform duration-300 group-hover:scale-110">
